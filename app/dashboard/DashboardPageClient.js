...
import { FileText, Download, Plus, BarChart3, ArrowRight, Trash2 } from "lucide-react";
              ...
              >
                ...
                <div className="mb-4">
                  <p className="text-sm text-gray-600">
                    Country: <span className="font-medium">{report.country}</span>
                  </p>
                  <p className="text-sm text-gray-600">
                    Type: <span className="font-medium capitalize">{report.type}</span>
                  </p>
                  <p className="text-sm text-gray-600">
                  ...
                  <div className="mt-2 p-2 bg-gray-50 rounded">
                    <p className="text-xs text-gray-600">
                      Overall Score: <span className="font-medium">{report.score}</span>
                    </p>
                    <p
